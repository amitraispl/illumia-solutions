...
const challenges = [
  ...
  },
  {
    ...
    body: "Lifebank's data protection relied entirely on Veeam Backup & Replication. With a platform migration inevitable, retaining Veeam would mean carrying a redundant cost that no longer aligned with the new direction.",
  },
  {
    title: "Workload Continuity Risk",
    body: "40% of workloads were classified Critical (max 1 hour downtime), 30% Medium (up to 4 hours), and 30% Low (up to 24 hours) — all windows restricted to weekends and off-hours only.",
  },
  {
    title: "No New Hardware Permitted",
    body: "Lifebank had a firm position of zero new hardware procurement. The entire migration had to execute within the existing physical footprint — leaving no margin for error in capacity planning.",
  },
  {
    title: "Orphaned VM Workloads",
    body: "A subset of VMs existed only within the Veeam backup repository with no active presence in VMware. These workloads still held business relevance and needed to be recovered and re-platformed.",
  },
];
...
const solutionItems = [
  {
    ...
    body: "ISPL recommended Proxmox VE — an enterprise-grade open-source hypervisor with native VMware migration tooling, cluster HA, full SAN compatibility, and Proxmox's official subscription support model.",
  },
  {
    title: "Phased Rolling Node Migration",
    body: "Rather than a bulk cutover, ISPL proposed a node-by-node rolling migration: each host decommissioned from VMware, commissioned as a Proxmox VE node, and validated before the next host was touched.",
  },
  {
    title: "Existing SAN Infrastructure Reused",
    body: "~40% available storage headroom in the dual SAN setup was sufficient to carve new LUNs for the Proxmox VE cluster without disrupting active VMware workloads during the transition.",
  },
  {
    title: "Recovery of Orphaned VMs",
    body: "VMs present only in the Veeam repository were restored directly via Veeam's standard VM restore procedure and onboarded into the Proxmox VE cluster as part of the migration scope.",
  },
  {
    title: "Proxmox Backup Server Replaces Veeam",
    body: "Both Veeam servers were repurposed as Proxmox Backup Server nodes — maintaining the on-site/off-site replication architecture with encryption at rest applied to all backup data.",
  },
];
...
const phases = [
  {
    ...
    body: "ISPL identified the VMware hosts running lowest-priority VMs, consolidated workloads onto remaining hosts, removed two hosts from vSphere, installed Proxmox VE, and formed a 2-node PVE cluster. New LUNs were carved from existing SAN headroom and integrated as shared storage.",
  },
  {
    num: "02",
    title: "Initial Workload Migration to Proxmox VE",
    body: "VMs from the freed VMware hosts were migrated using Proxmox VE's built-in VMware migration tooling via an offline method — clean shutdown before transfer to guarantee data consistency. Each VM was validated with application owners before the next was started.",
  },
  {
    num: "03",
  ...
  },
  {
    ...
    body: "VMs existing only in the Veeam backup repository were restored directly from Veeam backups using Veeam's standard VM restore procedure, brought online within the Proxmox VE cluster, and validated.",
  },
  {
    num: "05",
    title: "PBS Commissioning & Veeam Decommissioning",
    body: "Both Veeam servers were decommissioned. Hardware repurposed as PBS nodes: primary on-site PBS datastore integrated with PVE cluster, scheduled backup jobs with encryption at rest, off-site PBS node configured for encrypted replication. End-to-end backup and restore workflow validated before sign-off.",
  },
];
...
const outcomes = [
  { value: "80%", title: "Licensing Cost Reduction", body: "Immediate and sustained financial relief — the primary driver that initiated the engagement." },
  ...
  { value: "0", title: "Downtime Threshold Breaches", body: "All workload migrations scheduled within permissible windows — Critical within 1 hour, no exceptions." },
  { value: "$0", title: "Capital Expenditure", body: "The entire transformation executed within the existing hardware footprint — purely a service engagement." },
];

export default function ProxmoxMigrationCaseStudy() {
        ...
        <div className="mx-auto max-w-7xl px-6 pt-28 pb-16 lg:px-8 lg:pt-32 lg:pb-20">
          <div className="grid items-center gap-12 lg:grid-cols-12">
            <div className="lg:col-span-8">
              <div className="pm-hero-fade inline-flex items-center gap-2 rounded-full border border-[#b31c33]/30 bg-[#b31c33]/5 px-3 py-1 text-xs font-semibold uppercase tracking-[0.18em] text-[#b31c33]">
                Case Study
              </div>
              ...
              <div className="pm-hero-fade mt-8 flex flex-wrap gap-2">
                {["Proxmox VE", "VMware Migration", "Proxmox Backup Server", "HCI", "Non-Profit", "Philippines"].map((b) => (
            ...
            <div className="sticky top-24">
              ...
              <div className="mt-8 overflow-hidden rounded-2xl border border-[#e2bebd]/60">
                ...
                <div className="p-4">
                  ...
                  <p className="mt-2 text-sm text-[#5a4040]">ISPL is an official Proxmox partner with deep enterprise infrastructure expertise.</p>
                </div>
              </div>
            </div>
          </aside>
          ...
          <div className="space-y-20 lg:col-span-9">
            ...
            <section id="background" className="pm-rise scroll-mt-32">
              ...
              <div className="mt-6 space-y-4 text-base leading-relaxed text-[#5a4040]">
                <p>
                  Lifebank Foundation Inc., a non-profit microfinance organization based in the Philippines, operated a
                  business-critical IT infrastructure built around a multi-node VMware vSphere cluster hosting a significant
                  number of Virtual Machines — from mission-critical financial applications to supporting business functions —
                  all demanding high availability.
                </p>
                <p>
                  The storage backbone consisted of a dual SAN setup: two SAN switches connected to two SAN servers, providing
                  centralized high-performance shared storage. For data protection, Lifebank ran Veeam Backup &amp; Replication
            ...
            <section id="implementation" className="pm-rise scroll-mt-32">
              ...
              <p className="mt-4 text-base leading-relaxed text-[#5a4040]">
                ...
                scheduled within permitted off-hour weekend windows aligned to workload downtime tiers.
              </p>

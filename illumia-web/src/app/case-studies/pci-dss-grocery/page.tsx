        ...
        <div className="mx-auto max-w-7xl px-6 pt-28 pb-16 lg:px-8 lg:pt-32 lg:pb-20">
          <div className="grid items-center gap-12 lg:grid-cols-12">
            <div className="lg:col-span-7">
              <div className="pci-hero-fade flex flex-wrap items-center gap-3">
            ...
            <div className="pci-hero-fade lg:col-span-5 flex flex-col items-center gap-10 lg:mt-10">
              ...
              {/* Scroll indicator */}
              <style>{`
                @keyframes pci-scroll-dot {
                  0%   { transform: translateY(0);    opacity: 1; }
                  65%  { transform: translateY(10px); opacity: 0; }
                  100% { transform: translateY(0);    opacity: 0; }
                }
                .pci-scroll-dot { animation: pci-scroll-dot 1.8s cubic-bezier(0.45,0,0.55,1) infinite; }
              `}</style>
              <div className="flex flex-col items-center gap-2.5" aria-label="Scroll down to read">
                ...
                <div className="relative flex h-9 w-[22px] items-start justify-center rounded-full border border-[#b31c33]/25 pt-[7px] shadow-[0_0_0_4px_rgba(179,28,51,0.04)]">
                  <div className="pci-scroll-dot h-[7px] w-[3px] rounded-full bg-[#b31c33]/50" />
                </div>
              </div>
            </div>
          </div>
